...
struct Comments {
    ...
    init?(snapshot: DataSnapshot) {
        //MARK: - Database is taking a snapshot of the item once it has been initialized, sends item to Firebase database
        ...
        //MARK: - Read items from online and set them within our app as items
